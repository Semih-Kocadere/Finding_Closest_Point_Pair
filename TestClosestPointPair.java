...
public class TestClosestPointPair {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Rad Files
        Point2D.Double[] smallerSet = ReadFile("PointFiles/SmallerSet.input");
        Point2D.Double[] oneHundredPoints = ReadFile("PointFiles/test_100.input");
        Point2D.Double[] oneThousandPoints = ReadFile("PointFiles/test_1000.input");
        Point2D.Double[] tenThousandPoints = ReadFile("PointFiles/test_10000.input");
        Point2D.Double[] oneHundredThousandPoints = ReadFile("PointFiles/test_100000.input");
